...
class Reviewsclient extends Controller {
    ...
    function index() {
        ...
        //Цены
        /////Продукты, сайтбар
        $data['template'] = 'client/reviews/view_text';
        ...
        $query = $this->page->get_one('staticreviews');
        $data['staticreviews'] = $query;
        //Статичные отзывы
        $reviews = $this->reviews->get_all_moderate_text();
        if (!empty($reviews)) {
    ...
    function video() {
        ...
        //Цены
        /////Продукты, сайтбар
        $data['template'] = 'client/reviews/view_video';
        $data['sidebar_product'] = 'true';
