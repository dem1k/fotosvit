...
<?=form_open_multipart('admin/news/edit/'.$id);?>
...
<table cellspacing="0">
    <tr>
        ...
        <td>
            <input type="text" name="name" value="<?= set_value('name',$news->name); ?>"/>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <textarea name="description"><?=set_value("description",$news->description)?></textarea>
        </td>
    </tr>
</table>
